...
from mixprop.features import load_features, load_valid_atom_or_bond_features, is_mol
...
def filter_invalid_smiles(data: MoleculeDataset) -> MoleculeDataset:
    ...
    :param data: A :class:`~mixprop.data.MoleculeDataset`.
    :return: A :class:`~mixprop.data.MoleculeDataset` with only the valid molecules.
    """
...
def get_data(path: str,
    ...
    :param args: Arguments, either :class:`~mixprop.args.TrainArgs` or :class:`~mixprop.args.PredictArgs`.
    ...
    :param store_row: Whether to store the raw CSV row in each :class:`~mixprop.data.data.MoleculeDatapoint`.
    ...
    :return: A :class:`~mixprop.data.MoleculeDataset` containing SMILES and target values along
...
def get_data_from_smiles(smiles: List[List[str]],
    ...
    """
    Converts a list of SMILES to a :class:`~mixprop.data.MoleculeDataset`.
    ...
    :return: A :class:`~mixprop.data.MoleculeDataset` with all of the provided SMILES.
    """
    debug = logger.debug if logger is not None else print
...
def split_data(data: MoleculeDataset,
    ...
    :param args: A :class:`~mixprop.args.TrainArgs` object.
    :param logger: A logger for recording output.
    :return: A tuple of :class:`~mixprop.data.MoleculeDataset`\ s containing the train,
...
def get_class_sizes(data: MoleculeDataset) -> List[List[float]]:
    ...
    :param data: A classification :class:`~mixprop.data.MoleculeDataset`.
