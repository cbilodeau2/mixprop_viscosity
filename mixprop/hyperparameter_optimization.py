...
from mixprop.args import HyperoptArgs
from mixprop.constants import HYPEROPT_LOGGER_NAME
from mixprop.models import MoleculeModel
from mixprop.nn_utils import param_count
from mixprop.train import cross_validate, run_training
from mixprop.utils import create_logger, makedirs, timeit
from mixprop.hyperopt_utils import merge_trials, load_trials, save_trials, get_hyperopt_seed, load_manual_trials
...
def hyperopt(args: HyperoptArgs) -> None:
    """
    Runs hyperparameter optimization on a mixprop model.
    ...
    * :code:`ffn_num_layers`: The number of feed-forward layers after message passing is selected from {1, 2, 3}
    ...
    :param args: A :class:`~mixprop.args.HyperoptArgs` object containing arguments for hyperparameter
...
def mixprop_hyperopt() -> None:
    """Runs hyperparameter optimization for a mixprop model.

    This is the entry point for the command line command :code:`mixprop_hyperopt`.
    """
